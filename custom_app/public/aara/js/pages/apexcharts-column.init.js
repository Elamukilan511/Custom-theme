        ...
        series: [
          {
            name: "Daily",
            data: [
              46, 57, 59, 54, 62, 58, 64, 60, 66, 54, 46, 57, 59, 54, 62, 58,
              64, 60, 66, 54, 46, 57, 59, 54
            ],
          },
          {
            name: "Weekly",
            data: [
              74, 83, 102, 97, 86, 106, 93, 114, 94, 97, 74, 83, 102, 97, 86,
              106, 93, 114, 94, 97, 74, 83, 102, 97
            ],
          },
          {
            name: "Monthly",
            data: [
              37, 42, 38, 26, 47, 50, 54, 55, 43, 26, 37, 42, 38, 26, 47, 50,
              54, 55, 43, 26, 37, 42, 38, 26
            ],
          },
        ],
        ...
        series: [
          {
            name: "Daily",
            data: [
              46, 57, 59, 54, 62, 58, 64, 60, 66, 54
            ],
          },
          {
            name: "Weekly",
            data: [
              74, 83, 102, 97, 86, 106, 93, 114, 94, 97
            ],
          },
          {
            name: "Monthly",
            data: [
              37, 42, 38, 26, 47, 50, 54, 55, 43, 26
            ],
          },
        ],
        colors: chartColumnColors,
...
var chart,
  ...
  chartColumnDistributedColors =
    ...
    chart.addEventListener("dataPointSelection", function (e, t, o) {
      ...
      1 !== o.selectedDataPoints[0].length ||
        a.classList.contains("active") ||
        (r.classList.add("chart-quarter-activated"), a.classList.add("active")),
        updateQuarterChart(t, "barQuarter"),
        0 === o.selectedDataPoints[0].length &&
          (r.classList.remove("chart-quarter-activated"),
          a.classList.remove("active"));
